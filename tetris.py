...
class Tetris(object):
    ...
    def __init__(self, bx, by):
        ...
        self.block_data = (
            ([[0, 0], [1, 0], [2, 0], [3, 0]], constants.RED, True),  # - block
            ...
            ([[0, 0], [1, 0], [2, 0], [0, 1]], constants.CYAN, True),  # Г block
        )
    ...
    def load_best_score(self):
        try:
            ...
            # Если файл не найден, устанавливаем лучший счет в 0
            self.best_score = 0

    def save_best_score(self):
        with open("best_score.pkl", "wb") as f:
            pickle.dump(self.best_score, f)
    ...
    def print_status_line(self):
        ...
        """
        string = ["SCORE: {0}   SPEED: {1}x   BEST SCORE: {2}".format(self.score, self.speed, self.best_score)]
